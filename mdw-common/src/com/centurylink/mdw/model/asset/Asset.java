...
public class Asset implements Comparable<Asset> {
    ...
    public boolean meetsVersionSpec(String versionSpec) {
        AssetVersion assetVersion = new AssetVersion(getId(), getQualifiedName(), getVersionString());
        return assetVersion.meetsSpec(new AssetVersionSpec(getQualifiedName(), versionSpec));
    }
