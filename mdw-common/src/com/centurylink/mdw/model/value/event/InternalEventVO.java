...
public class InternalEventVO {
	...
	public InternalEventVO(String xmlMessage) throws XmlException {
		this();
    ...
    public static InternalEventVO createProcessStartMessage(
    	...
    	InternalEventVO event = new InternalEventVO();
...
//    	event.parameters = params;
    ...
    public static InternalEventVO createProcessFinishMessage(ProcessInstanceVO processInst){
    	InternalEventVO event = new InternalEventVO();
    	event.isProcess = true;
    ...
    public static InternalEventVO createProcessAbortMessage(ProcessInstanceVO processInst){
    	InternalEventVO event = new InternalEventVO();
    	event.isProcess = true;
    	event.workInstanceId = processInst.getId();
    	return event;
    ...
    public static InternalEventVO createActivityDelayMessage(ActivityInstanceVO actInst,
    ...
    public static InternalEventVO createActivityStartMessage(
    ...
    public static InternalEventVO createActivityErrorMessage(
     ...
     * @return
     */
    public static InternalEventVO createActivityNotifyMessage(ActivityInstanceVO ai,
