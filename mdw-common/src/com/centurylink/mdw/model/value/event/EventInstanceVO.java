...
public class EventInstanceVO implements Serializable{
	...
	private List<EventWaitInstanceVO> waiters;	// for CACHE_ONLY engine mode only

    public EventInstanceVO(){
    }
    ...
    public List<EventWaitInstanceVO> getWaiters() {
    	return this.waiters;
    }
    
    public void setWaiters(List<EventWaitInstanceVO> waiters) {
