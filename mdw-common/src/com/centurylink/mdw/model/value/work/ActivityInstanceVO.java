...
public class ActivityInstanceVO implements Jsonable, Serializable {
    ...
    public ActivityInstanceVO() {
    }

    public ActivityInstanceVO(JSONObject json) throws JSONException {
        if (json.has("id"))
            id = json.getLong("id");
