...
public class UserList implements Jsonable, InstanceList<UserVO> {

    public UserList(List<UserVO> users) {
        this.users = users;
    ...
    public UserList(String json) throws JSONException {
        ...
        if (jsonObj.has("users")) {
            ...
            for (int i = 0; i < userList.length(); i++)
                users.add(new UserVO((JSONObject)userList.get(i)));
        }
    }
