...
import com.centurylink.mdw.common.utilities.ParseException;
...
public class UserActionVO implements Serializable, Comparable<UserActionVO>, Jsonable {
    ...
    public UserActionVO(String xml) throws ParseException {
        fromXml(xml);
    }

    public UserActionVO(JSONObject json) throws JSONException {
        fromJson(json);
    }

    public UserActionVO(String user, Action action, Entity entity, Long entityId, String description) {
        this.user = user;
        this.action = action;
        this.entity = entity;
    ...
    public UserActionVO(Action action, String user, Entity entity, Long entityId) {
     ...
     */
    @Override
    public int compareTo(UserActionVO o) {
