...
public class WorkgroupList implements Jsonable, InstanceList<UserGroupVO> {

    public WorkgroupList(List<UserGroupVO> groups) {
        this.groups = groups;
    ...
    public WorkgroupList(String json) throws JSONException {
        ...
        if (jsonObj.has("workgroups")) {
            ...
            for (int i = 0; i < groupList.length(); i++)
                groups.add(new UserGroupVO((JSONObject)groupList.get(i)));
        }
    ...
    private List<UserGroupVO> groups = new ArrayList<UserGroupVO>();
    public List<UserGroupVO> getGroups() { return groups; }
    public void setGroups(List<UserGroupVO> groups) { this.groups = groups; }

    public List<UserGroupVO> getItems() {
        return groups;
    }
    ...
    public UserGroupVO get(String name) {
