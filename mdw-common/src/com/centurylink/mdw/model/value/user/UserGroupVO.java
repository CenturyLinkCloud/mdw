...
public class UserGroupVO implements Serializable, Comparable<UserGroupVO>, Jsonable {
    ...
    public static final UserGroupVO getCommonGroup() {
        return new UserGroupVO(COMMON_GROUP_ID, UserGroupVO.COMMON_GROUP, null);
    }

    public UserGroupVO() {
    }

    public UserGroupVO(Long id, String name, String comment) {
        this.id = id;
        this.name = name;
     ...
     * @param nameAndRoles
     */
    public UserGroupVO(String nameAndRoles) {
        id = null;
        description = null;
    ...
    public UserGroupVO(JSONObject json) throws JSONException {
    ...
    public String getRolesAsString() {
        ...
        if (roles != null && roles.size() > 0) {
            ...
            if (DEFAULT_ALL_ROLES)
                return UserRoleVO.ALL;
            else
                return UserRoleVO.VIEW_ONLY;
        }
    }
    ...
    public int compareTo(UserGroupVO other) {
        if (this.name == null)
            return 0;
        else
    ...
    public boolean equals(Object o) {
        if (!(o instanceof UserGroupVO))
            return false;
        return getId().equals(((UserGroupVO)o).getId());
    }
     ...
     */
    @Deprecated
    public void setGroupName(String groupName) { setName(groupName); }
    /**
