...
public class Changes {
	...
	public Changes(List<AttributeVO> attrs) {
		changeType = NONE;
		changes = null;
		String cv = attrs==null?null:AttributeVO.findAttribute(attrs, ATTRIBUTE_CHANGES);
		fromString(cv);
	}
	...
	public void fromAttributes(List<AttributeVO> attrs) {
		changeType = NONE;
		changes = null;
		String cv = attrs==null?null:AttributeVO.findAttribute(attrs, ATTRIBUTE_CHANGES);
		fromString(cv);
	...
	public void toAttributes(List<AttributeVO> attrs) {
		String av = toString();
		AttributeVO.setAttribute(attrs, ATTRIBUTE_CHANGES, av);
	}
