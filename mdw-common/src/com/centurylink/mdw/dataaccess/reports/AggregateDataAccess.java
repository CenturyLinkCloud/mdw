...
public interface AggregateDataAccess<T extends Aggregate> {
     ...
     */
    List<T> getTops(Query query) throws DataAccessException, ServiceException;
     ...
     */
    TreeMap<Date,List<T>> getBreakdown(Query query) throws DataAccessException, ServiceException;
}
