 ...
 */
package com.centurylink.mdw.common.utilities.logger.log4j;
...
import com.centurylink.mdw.common.utilities.logger.AbstractStandardLoggerBase;
...
public class Log4JStandardLoggerImpl extends AbstractStandardLoggerBase implements CacheEnabled {
    ...
    @Deprecated
    public static StandardLogger getLoggerInstance() {
        return new Log4JStandardLoggerImpl();
    }

    @Deprecated
    public static StandardLogger getLoggerInstance(String className) {
