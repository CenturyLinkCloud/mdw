package com.centurylink.mdw.common.utilities.bpmn;
...
public class BPMNHelper {
    ...
    public void exportProcess(ProcessVO processVO, String filename) {
     ...
     * @param processVO
     */
    private void addProcessElements(TBaseElement myprocess, ProcessVO processVO) {
        // Add activities
     ...
     * @param processVO
     */
    private void addTextNotes(TBaseElement myprocess, ProcessVO processVO) {
     ...
     * @param processVO
     */
    private void addSubprocesses(TBaseElement myprocess, ProcessVO processVO) {
     ...
     * @param processVO
     */
    private void addTransitions(TBaseElement myprocess, ProcessVO processVO) {
        List<WorkTransitionVO> connectors = processVO.getTransitions();
        for (WorkTransitionVO conn : connectors) {
            XmlObject flow = getProcessFlowElement(myprocess);
     ...
     * @param processVO
     */
    private void addActivities(TBaseElement myprocess, ProcessVO processVO) {
        /**
         * Iterate through activities and add
         * TODO add BPMNtoMDWmappings.json
         */
        List<ActivityVO> acts = processVO.getActivities();
     ...
     * @return
     */
    private TProcess createProcess(XmlObject root, ProcessVO processVO) {
