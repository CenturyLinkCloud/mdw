...
public class SyncExpressionEvaluator {
	...
	public boolean evaluate(List<String> completedActivities, List<VariableInstanceInfo> variableInstances)
    throws SynchronizationException {
        ...
        try {
            ...
            if (variableInstances != null) {
                // set the variables
                for (VariableInstanceInfo variableInstance : variableInstances) {
