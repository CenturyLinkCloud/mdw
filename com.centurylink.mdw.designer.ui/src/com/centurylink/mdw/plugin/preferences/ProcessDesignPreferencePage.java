...
public class ProcessDesignPreferencePage extends PreferencePage implements PreferenceConstants {
    ...
    protected void storeValues() {
        ...
        store.setValue(PREFS_ALLOW_DELETE_ARCHIVED_PROCESSES,
                allowDeleteArchivedProcessesCheckbox.getSelection());
        ...
        store.setValue(PREFS_EMBEDDED_EDITOR_FOR_EXCEL,
                embeddedEditorForExcelCheckbox.getSelection());
        ...
        store.setValue(PREFS_PREVIOUS_TEMP_FILE_VERSIONS_TO_KEEP,
                previousTempFileVersionsSpinner.getSelection());
    ...
    protected void initializeValues() {
        ...
        allowDeleteArchivedProcessesCheckbox
                .setSelection(store.getBoolean(PREFS_ALLOW_DELETE_ARCHIVED_PROCESSES));
        ...
        previousTempFileVersionsSpinner
                .setSelection(store.getInt(PREFS_PREVIOUS_TEMP_FILE_VERSIONS_TO_KEEP));
    ...
    protected void initializeFromDefaults() {
        ...
        doubleClickOpensSubprocsAndScriptsCheckbox.setSelection(
        ...
        embeddedEditorForExcelCheckbox
                .setSelection(store.getDefaultBoolean(PREFS_EMBEDDED_EDITOR_FOR_EXCEL));
