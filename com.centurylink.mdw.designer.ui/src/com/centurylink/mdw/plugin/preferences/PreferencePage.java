 ...
 */
public abstract class PreferencePage extends org.eclipse.jface.preference.PreferencePage implements IWorkbenchPreferencePage
{
   ...
   * @param parent the parent for the new label
   * @param text the text for the new label
   * @param span columns to span horizontally
   * @return the new label
   */
  ...
  /**
   * utility method that creates a push button instance and sets the
   * default layout data.
   *
  ...
  /**
   * utility method that creates a radio button instance and sets the
   * default layout data.
   *
   * @param parent  the parent for the new button
   * @param label  the label for the new button
   ...
   * @param width the width to make the field
   * @param span horizontal span
   * @param whether the text field should be read-only
   ...
   * creates a text area
   *
   * @param parent the parent of the new text area
   * @param height the height to make the area
   ...
   *
   * @param parent the parent of the new password field
   * @return the new text field
   */
   ...
   * @param span number of columns to span horizontally
   ...
   * @param cols number of columns to include in layout
