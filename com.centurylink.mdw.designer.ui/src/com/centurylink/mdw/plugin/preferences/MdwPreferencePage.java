...
public class MdwPreferencePage extends PreferencePage implements PreferenceConstants {
    ...
    protected Control createContents(Composite parent) {
        ...
        // log connect errors
        logConnectErrorsCheckbox = createCheckbox(parent,
                "Log routine connection/translation errors", 3);
        ...
        createSpacer(parent);
        useDiscoveredVcsCredsCheckbox = createCheckbox(parent,
                "Use discovered VCS credentials if available", 1);
    ...
    protected void storeValues() {
        ...
        store.setValue(PREFS_SWING_LAUNCH_THREAD_POOL_MANAGER,
                threadPoolManagerCheckbox.getSelection());
        store.setValue(PREFS_USE_DISCOVERED_VCS_CREDS,
                useDiscoveredVcsCredsCheckbox.getSelection());
    }
    ...
    protected void initializeValues() {
        ...
        mdwReportingLevelCombo.setText(reportingLevel + " - "
                + PluginMessages.MESSAGE_LEVELS.get(new Integer(reportingLevel)));
        ...
        threadPoolManagerCheckbox
                .setSelection(store.getBoolean(PREFS_SWING_LAUNCH_THREAD_POOL_MANAGER));
        useDiscoveredVcsCredsCheckbox
                .setSelection(store.getBoolean(PREFS_USE_DISCOVERED_VCS_CREDS));
    }
    ...
    protected void initializeFromDefaults() {
        ...
        mdwReportingLevelCombo
                .setText(PluginMessages.MESSAGE_LEVELS.get(new Integer(defaultReportingLevel)));
