...
public class ServerConsoleSettings implements PreferenceConstants
{
  ...
  public FontData getFontData() { return fontData; }
  public void setFontData(FontData fd) { fontData = fd; }
  
  private RGB fontRgb;
  public RGB getFontRgb() { return fontRgb; }
  public void setFontRgb(RGB rgb) { this.fontRgb = rgb; }
  
  private RGB backgroundRgb;
  public RGB getBackgroundRgb() { return backgroundRgb; }
  public void setBackgroundRgb(RGB rgb) { backgroundRgb = rgb; }
  ...
  public ClientShell getClientShell() { return clientShell; }
  public void setClientShell(ClientShell clientShell) { this.clientShell = clientShell; }
  
  private File clientShellExe;
  public File getClientShellExe() { return clientShellExe; }
  public void setClientShellExe(File shellExe) { this.clientShellExe = shellExe; }
  ...
  /**
   * Specifies the default values for server console prefs.
   * Will only be active before the user has configured anything.
   */
  public static void setDefaultValues()
  {
    IPreferenceStore store = MdwPlugin.getDefault().getPreferenceStore();
    store.setDefault(PREFS_SERVER_CONSOLE_BUFFER_SIZE, PREFS_DEFAULT_SERVER_CONSOLE_BUFFER_SIZE);
