...
public class ServerAttributeSetterCommand extends AbstractOperation
{
  ...
  public ServerAttributeSetterCommand(IServerWorkingCopy server, String attribute, String setting, String defaultSetting)
  {
    super(attribute);
    this.server = server;
  ...
  public ServerAttributeSetterCommand(IServerWorkingCopy server, String attribute, int setting, int defaultSetting)
  {
    super(attribute);
    this.server = server;
    this.attribute = attribute;
  ...
  public ServerAttributeSetterCommand(IServerWorkingCopy server, String attribute, boolean setting, boolean defaultSetting)
  {
    super(attribute);
    this.server = server;
    this.attribute = attribute;
