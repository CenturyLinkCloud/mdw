...
public abstract class MdwServerOptionsSection extends ServerEditorSection
    ...
    public void createSection(Composite parent) {
        ...
        javaOptionsTextField = new Text(composite,
        ...
        javaOptionsTextField.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                ...
                IUndoableOperation cmd = new ServerAttributeSetterCommand(server, JAVA_OPTIONS,
                        opts, getDefaultJavaOptions());
                execute(cmd);
            }
        });
        ...
        debugCheckbox.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                ...
                IUndoableOperation cmd = new ServerAttributeSetterCommand(server, DEBUG_MODE, debug,
                        getDefaultDebugMode());
                execute(cmd);
            }
        });
        ...
        debugPortTextField.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                ...
                try {
                    IUndoableOperation cmd = new ServerAttributeSetterCommand(server, DEBUG_PORT,
                            Integer.parseInt(port), DEFAULT_DEBUG_PORT);
                    execute(cmd);
                }
        ...
        suspendCheckbox.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                ...
                IUndoableOperation cmd = new ServerAttributeSetterCommand(server, DEBUG_SUSPEND,
                        suspend, DEFAULT_DEBUG_SUSPEND);
                execute(cmd);
            }
        });
