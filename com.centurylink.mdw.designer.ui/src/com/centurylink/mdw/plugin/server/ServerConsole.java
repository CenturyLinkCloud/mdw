 ...
 */
public class ServerConsole extends JavaProcessConsole
        implements IPropertyChangeListener, PreferenceConstants {
    // override console id
    ...
    public void addToMenuAndToolbar() {
        ...
        clientShellAction
                .setImageDescriptor(MdwPlugin.getImageDescriptor("icons/client_shell.gif"));
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (e.getProperty().equals(PREFS_SERVER_CONSOLE_FONT)) {
            ...
            boolean running = MdwPlugin.getDefault().getPreferenceStore()
                    .getBoolean(PREFS_SERVER_RUNNING);
            String serverName = MdwPlugin.getDefault().getPreferenceStore()
                    .getString(PREFS_RUNNING_SERVER);
            ...
            String projName = MdwPlugin.getDefault().getPreferenceStore()
                    .getString(PREFS_SERVER_WF_PROJECT);
