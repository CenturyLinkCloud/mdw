...
public class ServiceMixRuntimeWizardFragment extends WizardFragment
{
  ...
  public Composite createComposite(Composite parent, final IWizardHandle wizard)
  {
    ...
    wizard.setDescription("Specify your " + runtime.getName() + " installation root location (not an instance)");
    ...
    browseServerHomeButton.addSelectionListener(new SelectionAdapter()
    {
      public void widgetSelected(SelectionEvent e)
      {
        ...
        dlg.setMessage("Select the directory where " + runtime.getName() + " is installed.");
    ...
    // TODO: use installed JREs (see org.eclipse.jst.server.tomcat.ui.internal.TomcatRuntimeComposite)
