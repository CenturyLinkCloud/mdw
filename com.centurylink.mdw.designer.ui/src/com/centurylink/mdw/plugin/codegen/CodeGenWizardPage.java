...
public abstract class CodeGenWizardPage extends WizardPage
{
  ...
  protected void createWorkflowProjectControls(Composite parent, int ncol, SelectionListener selectionListener)
  {
    ...
    workflowProjectCombo.addSelectionListener(new SelectionAdapter()
    {
      public void widgetSelected(SelectionEvent e)
      {
        ...
        {
          for (WorkflowPackage packageVersion : getCodeElement().getProject().getTopLevelUserVisiblePackages())
  ...
  {
    registerOnlyButton.setEnabled(isRegistrationSupported());  // this is static
