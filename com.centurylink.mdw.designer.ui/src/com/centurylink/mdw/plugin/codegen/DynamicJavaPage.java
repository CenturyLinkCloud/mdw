...
public class DynamicJavaPage extends CodeGenWizardPage {
    ...
    protected boolean isPageValid() {
        if (getProject().getAsset(getCodeElement().getJavaPackage(),
                getCodeElement().getClassName()) != null
                || getProject().getAsset(getCodeElement().getJavaPackage(),
                        getCodeElement().getClassName() + ".java") != null)
            return false;
    ...
    public IStatus[] getStatuses() {
        ...
        if (getProject() != null) // is null before inference
        {
            if (getProject().getAsset(getCodeElement().getJavaPackage(),
                    ...
                    || getProject().getAsset(getCodeElement().getJavaPackage(),
                            getCodeElement().getClassName() + ".java") != null)
                msg = "Dynamic Java class already exists: " + getCodeElement().getJavaPackage()
                        + "." + getCodeElement().getClassName();
