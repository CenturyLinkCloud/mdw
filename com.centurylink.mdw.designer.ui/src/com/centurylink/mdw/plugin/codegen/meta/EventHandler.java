...
public class EventHandler extends Code
{
  ...
  public boolean isCreateDocument() { return createDocument; }
  public void setCreateDocument(boolean createDocument) { this.createDocument = createDocument; }

  private String documentVariable;
  public String getDocumentVariable() { return documentVariable; }
  public void setDocumentVariable(String documentVariable) { this.documentVariable = documentVariable; }
  ...
  public boolean isLaunchSynchronous() { return launchSynchronous; }
  public void setLaunchSynchronous(boolean launchSynchronous) { this.launchSynchronous = launchSynchronous; }
