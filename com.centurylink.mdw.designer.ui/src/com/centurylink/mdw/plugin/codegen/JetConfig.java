...
public class JetConfig {
    ...
    public void setClasspathVariable(String s) {
        classpathVariable = s;
    }
    ...
    public void setTemplateRelativeUri(String s) {
        templateRelativeUri = s;
    }
    ...
    public void setMergeXmlRelativeUri(String s) {
        mergeXmlRelativeUri = s;
    }
    ...
    public void setTargetFolder(String s) {
        targetFolder = s;
    }
    ...
    public void setTargetFile(String s) {
        targetFile = s;
    }
    ...
    public void setForceOverwrite(boolean b) {
        forceOverwrite = b;
    }
     ...
     * XML URI to the installation URI of the plugin.
     * 
     * @return the full URI
     */
