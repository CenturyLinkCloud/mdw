...
public abstract class CodeGenWizard extends Wizard implements INewWizard
{
  ...
  public CodeGenType getCodeGenType() { return codeGenType; }
  public void setCodeGenType(CodeGenType codeGenType) { this.codeGenType = codeGenType; }
  ...
  public MdwSettings getMdwSettings() { return mdwSettings; }
  ...
  public Code getCodeElement() { return codeElement; }
  public void setCodeElement(Code codeElement) { this.codeElement = codeElement; }
  ...
  {
    staticJavaPage = new StaticJavaPage("Custom Activity", "Enter the type info for your Activity.\n"
        + "This will be used to generate the activity implementor source code.");
    addPage(staticJavaPage);
    dynamicJavaPage = new DynamicJavaPage("Dynamic Java Activity", "Enter the type info for your custom Activity.\n"
        + "This will be used to generate the Dynamic Java source code.");
    addPage(dynamicJavaPage);
    registrationOnlyPage = new RegistrationOnlyPage("Register Activity", "Enter the class name for the Activity.\n"
  ...
  public abstract void generate(IProgressMonitor monitor) throws InterruptedException, CoreException;
  ...
  public boolean performFinish()
  {
    ...
    try
    {
      getContainer().run(false, true, new org.eclipse.jdt.internal.ui.actions.WorkbenchRunnableAdapter(op));
    }
  ...
  protected boolean handleGenerationException(Shell shell, InvocationTargetException e)
  {
    ...
    IStatus status = new Status(IStatus.ERROR, MdwPlugin.getPluginId(), IStatus.ERROR, exceptionMessage, e);
  ...
  public JetAccess getJet(String jetFile, String targetFolder, String targetFile, IPackageFragment pkg)
  {
  ...
  protected JavaSource createJavaAssetAndOpen(WorkflowPackage workflowPackage, String jetFile, String targetFolder, String targetFile, IProgressMonitor monitor)
