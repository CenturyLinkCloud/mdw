...
public class ViewLayoutEditAttributeDialog extends EditAttributeDialog {
    ...
    public ViewLayoutEditAttributeDialog(Shell parent, ViewLayout viewLayoutModel,
            Element ownerElement, Attr attribute) {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        if (attrOptions != null) {
            ...
            attributeValueCombo
                    .setText(getDisplayValue(attribute != null ? attribute.getValue() : ""));
