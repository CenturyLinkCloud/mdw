...
public class ProcessEditorActionBarContributor implements IEditorActionBarContributor
{
  ...
  public IAction getLockAction() { return lockAction; }
  ...
  public static String getLinkStyle() { return linkStyle; }
    ...
    private Menu createMenu(Control parent)
    {
      ...
      nodeIdTypeLogicalItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_CANVAS_NODE_ID_TYPE, Node.ID_LOGICAL);
        }
      });
      ...
      nodeIdTypeSequenceItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_CANVAS_NODE_ID_TYPE, Node.ID_SEQUENCE);
        }
      });
      ...
      nodeIdTypeReferenceItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_CANVAS_NODE_ID_TYPE, Node.ID_REFERENCE);
        }
      });
      ...
      nodeIdTypeDatabaseItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_CANVAS_NODE_ID_TYPE, Node.ID_DATABASE);
        }
      });
      ...
      nodeIdTypeNoneItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_CANVAS_NODE_ID_TYPE, Node.ID_NONE);
        }
      });
      ...
      showToolTipsItem.addSelectionListener(new SelectionAdapter()
      {
        public void widgetSelected(SelectionEvent e)
        {
          ...
          MdwPlugin.getDefault().getPreferenceStore().setValue(PreferenceConstants.PREFS_DESIGNER_SUPPRESS_TOOLTIPS, !isShowTips);
        }
      });
