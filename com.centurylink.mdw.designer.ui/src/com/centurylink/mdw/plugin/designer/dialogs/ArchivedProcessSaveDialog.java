...
public class ArchivedProcessSaveDialog extends TrayDialog {
    ...
    public ArchivedProcessSaveDialog(Shell shell, WorkflowProcess process,
    ...
    protected void okPressed() {
        ...
        if (!getButton(Dialog.OK).getText().equals("Force Save")
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        Button cancelButton = createButton(parent, IDialogConstants.CANCEL_ID,
                IDialogConstants.CANCEL_LABEL, !respondingToClose);
        if (!respondingToClose)
