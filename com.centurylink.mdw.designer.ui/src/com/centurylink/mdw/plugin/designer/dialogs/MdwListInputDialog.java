...
public class MdwListInputDialog extends ListDialog {
    ...
    public MdwListInputDialog(Shell parent, String title, String message,
            List<? extends WorkflowElement> elements) {
        super(parent);
        this.title = title;
    ...
    public MdwListInputDialog(Shell parent, String title, String message,
            List<? extends WorkflowElement> elements, boolean multiLine) {
