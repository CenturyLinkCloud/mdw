...
public class ProcessSaveDialog extends TrayDialog
{
  ...
  public void setAllowForceUpdate(boolean allow) { this.allowForceUpdate = allow; }

  public ProcessSaveDialog(Shell shell, WorkflowProcess processVersion, boolean respondingToClose)
  {
    super(shell);
