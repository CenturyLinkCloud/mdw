...
public class ActivityInstanceDialog extends TrayDialog
{
  ...
  public ActivityInstanceVO getActivityInstanceVO() { return activityInstanceVO; }
  ...
  public ActivityInstanceDialog(Shell shell, Activity activity, ActivityInstanceVO activityInstanceVO, Mode mode)
  {
    super(shell);
