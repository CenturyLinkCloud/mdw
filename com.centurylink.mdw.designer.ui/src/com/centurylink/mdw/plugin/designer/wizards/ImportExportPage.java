...
/**
 * Wizard selection should be a workflow project (import only), a (non-default) workflow package,
 * or an asset within a (non-default) package (export only).
 */
public abstract class ImportExportPage extends WizardPage
{
   ...
   */
  protected String getDefaultFileName() { return null; };
