...
public class ExportProjectPage extends WizardPage {
    ...
    private void createProjectListControls(Composite parent, int ncol) {
        ...
        ColumnSpec selectionColSpec = new ColumnSpec(PropertyEditor.TYPE_CHECKBOX, "Export",
                "export");
        ...
        projectTableEditor.setModelUpdater(new TableModelUpdater() {
            ...
            public void updateModelValue(List tableValue) {
                ...
                List<WorkflowProject> allProjects = WorkflowProjectManager.getInstance()
                        .getRemoteWorkflowProjects();
        ...
        List<WorkflowProject> remoteProjects = WorkflowProjectManager.getInstance()
                .getRemoteWorkflowProjects();
    ...
    private void createSelectButtonControls(Composite parent, int ncol) {
        ...
        selectAllButton.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                ...
                setProjectsToExport(
                        WorkflowProjectManager.getInstance().getRemoteWorkflowProjects());
