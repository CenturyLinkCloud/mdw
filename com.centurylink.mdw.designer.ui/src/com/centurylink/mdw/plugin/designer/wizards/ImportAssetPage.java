...
public class ImportAssetPage extends ImportExportPage
{
  ...
  boolean isPageValid()
  {
    return super.isPageValid() && (!getProject().isProduction() || getComments().length() > 0)
        && getExistingAssetEditor() == null && new File(getFilePath()).exists() && (getAsset() != null || getLanguageFromExtension() != null);
  }
  ...
  public IStatus[] getStatuses()
  {
    ...
    if (existingAssetEditor != null)
      msg = "'" + existingAssetEditor.getTitle() + "' is currently open in an editor.  Please save and close before importing.";
