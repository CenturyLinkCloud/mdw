...
public class ExportAttributesPage extends ImportExportPage
{
  ...
  {
    if (getProcess() != null)
      return getProcess().getName() + "-" + getProcess().getVersionString() + "_" + getPrefix() + "_Attributes.xml";
    else
      return getPackage().getName() + "-" + getPackage().getVersionString() + "_" + getPrefix() + "_Attributes.xml";
  }
