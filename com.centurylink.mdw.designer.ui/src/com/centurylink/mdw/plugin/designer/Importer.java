...
public class Importer
{
  ...
  public void importTaskTemplates(final WorkflowProject project, final String xml, final ProgressMonitor progressMonitor) throws XmlException, RemoteException, DataAccessException
  {
    progressMonitor.subTask("Parsing XML");
