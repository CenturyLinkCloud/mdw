...
public class Exporter
{
  ...
  public String exportPackages(List<WorkflowPackage> packages, ProgressMonitor progressMonitor)
  throws DataAccessException, RemoteException, ActionCancelledException, XmlException
  {
    ...
    xml = designerDataAccess.exportPackages(pkgVos, schemaVersion, progressMonitor);
    for (WorkflowPackage pv : packages)
      pv.setExported(true);
  ...
  public String exportPackage(WorkflowPackage packageVersion, boolean inferReferencedImplementors, ProgressMonitor progressMonitor)
  throws DataAccessException, RemoteException, ActionCancelledException, XmlException
  {
    String xml = null;
    ...
    int schemaVersion = designerDataAccess.getDatabaseSchemaVersion();
    xml = designerDataAccess.exportPackage(packageVersion.getId(), schemaVersion, progressMonitor);
