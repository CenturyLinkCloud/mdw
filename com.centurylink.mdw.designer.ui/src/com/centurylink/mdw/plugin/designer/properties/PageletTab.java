...
/**
 * Dynamic pagelet-driven tab content. Currently always treated as override
 * attributes: TODO: Support pagelet for non-override attributes (should be easy
 * when needed). Tabs are added automatically for the appropriate workflow
 * elements by virtue of a .pagelet asset. TODO: Allow pagelet def in a
 * process's same package to override others.
 */
public class PageletTab extends AbstractTabDescriptor {
    ...
    public String getOverrideAttributePrefix() {
        return label.toUpperCase(); // by convention (could add to pagelet
                                    // schema also)
    }
