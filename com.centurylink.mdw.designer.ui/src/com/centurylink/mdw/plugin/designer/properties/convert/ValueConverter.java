...
public interface ValueConverter {
    /**
     * Converts from the value stored on the PropertyEditor to a value that can
     * be used by the model.
     */
    public Object toModelValue(String propertyValue) throws ConversionException;

    /**
     * Converts from the value stored on the model to a value that can be
     * associated with a PropertyEditor.
     */
