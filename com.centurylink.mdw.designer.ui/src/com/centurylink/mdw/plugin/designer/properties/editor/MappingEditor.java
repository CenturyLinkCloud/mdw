...
public class MappingEditor extends TableEditor {
    ...
    public WorkflowProcess getOwningProcess() {
        return owningProcess;
    }

    public void setOwningProcess(WorkflowProcess pv) {
        this.owningProcess = pv;
    }

    private Map<Integer, VariableVO> mappedVariables;

    public Map<Integer, VariableVO> getMappedVariables() {
        return mappedVariables;
    }

    public void setMappedVariables(Map<Integer, VariableVO> mappedVars) {
        this.mappedVariables = mappedVars;
    }
    ...
    public void setValueAttr(String va) {
        this.valueAttr = va;
    }
    ...
    public void setVariableColumnLabel(String vcl) {
        this.variableColumnLabel = vcl;
    }

    private String bindingColumnLabel;

    public String getBindingColumnLabel() {
        return bindingColumnLabel;
    }

    public void setBindingColumnLabel(String bcl) {
        this.bindingColumnLabel = bcl;
    }
    ...
    private List<ColumnSpec> createDefaultColumnSpecs() {
        ...
        ColumnSpec variableColSpec = new ColumnSpec(PropertyEditor.TYPE_COMBO,
                getVariableColumnLabel(), "variable");
        ...
        ColumnSpec bindingColSpec = new ColumnSpec(PropertyEditor.TYPE_TEXT,
                getBindingColumnLabel(), "binding");
