...
public class PrePostScriptSection extends PropertySection implements IFilter {
    ...
    public void setSelection(WorkflowElement selection)
    {
      ...
      if (null == activity.getAttribute(WorkAttributeConstant.PRE_SCRIPT_LANGUAGE))
        activity.setAttribute(WorkAttributeConstant.PRE_SCRIPT_LANGUAGE, preScriptArtifactEditor.getValueProvider().getDefaultLanguage());
      ...
      if (null == activity.getAttribute(WorkAttributeConstant.POST_SCRIPT_LANGUAGE))
        activity.setAttribute(WorkAttributeConstant.POST_SCRIPT_LANGUAGE, postScriptArtifactEditor.getValueProvider().getDefaultLanguage());
    ...
    private ArtifactEditorValueProvider getNewScriptValueProvider(boolean preScript) {
        ...
        return new ScriptEditorValueProvider(activity) {
            ...
            public String getTempFileName() {
                String ext = WorkflowElement.getArtifactFileExtensions().get(activity.getAttribute(scriptLang));
                String id = activity.getLogicalId();
                return FileHelper.stripDisallowedFilenameChars(getElement().getName()) + "_" + scriptRule + "_" + id + ext;
            }
