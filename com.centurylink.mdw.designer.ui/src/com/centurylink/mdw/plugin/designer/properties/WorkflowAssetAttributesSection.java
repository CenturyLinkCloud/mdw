...
public class WorkflowAssetAttributesSection extends DesignSection
    ...
    public void setSelection(WorkflowElement selection) {
        ...
        if (workflowAsset.getCustomAttribute().getDefinition() == null) {
            ...
            propertyEditors = new PropertyEditorList(workflowAsset,
                    workflowAsset.getCustomAttribute().getDefinition());
            for (PropertyEditor propertyEditor : propertyEditors) {
    ...
    private void saveAttributes() {
        BusyIndicator.showWhile(getShell().getDisplay(), new Runnable() {
            public void run() {
                ...
                wfProj.getDataAccess().setAttributes("RULE_SET", workflowAsset.getId(),
                        workflowAsset.getAttributes());
