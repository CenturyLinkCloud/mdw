...
public class PackagePermissionsSection extends PropertySection implements IFilter {
    ...
    public void setSelection(WorkflowElement selection) {
        ...
        sysAdminPermissionsEditor
                .setValue(workflowPackage.getProject().isUserAuthorizedForSystemAdmin());
    ...
    public void drawWidgets(Composite composite, WorkflowElement selection) {
        ...
        // sys admin checkbox
        sysAdminPermissionsEditor = new PropertyEditor(workflowPackage,
                PropertyEditor.TYPE_CHECKBOX);
    ...
    private void launchMdwHub() {
        WebLaunchActions.getLaunchAction(workflowPackage.getProject(), WebApp.MdwHub)
                .launch(workflowPackage.getProject());
    }

    private void reloadPermissions() {
        try {
            workflowPackage.getDesignerDataModel().reloadPriviledges(
                    workflowPackage.getProject().getDesignerDataAccess(),
