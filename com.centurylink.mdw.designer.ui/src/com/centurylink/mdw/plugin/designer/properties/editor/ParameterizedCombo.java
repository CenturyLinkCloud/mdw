...
public class ParameterizedCombo extends Composer
{
  ...
  public ParameterizedCombo(Composite parent, WorkflowElement workflowElement, ParameterizedValueConverter valueConverter, int style, int width, boolean readOnly)
  {
