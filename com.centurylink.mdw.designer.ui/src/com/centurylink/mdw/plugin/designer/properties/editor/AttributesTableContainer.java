...
public class AttributesTableContainer
{
  ...
  public AttributesTableContainer(Composite parent, boolean readOnly, int width, int colspan, TableT pageletTable)
  {
  ...
  private void createTableEditor(Composite parent)
  {
    ...
    tableEditor.addValueChangeListener(new ValueChangeListener()
    {
      public void propertyValueChanged(Object newValue)
      {
        ...
        //AttributeDialog dialog = new AttributeDialog(parent.getShell(), attributeVO);
        //dialog.open();
      }
    });
    ...
    public Object getValue(Object element, String property)
    {
      ...
      if (widget instanceof DropdownT && VALUE.equals(colSpec.property))
      {
        ...
        for (int i = 0; i < dropdown.getOPTIONList().size(); i++)
        {
          ...
          if (option.getStringValue().equals(attribute.getAttributeValue())
              || (option.getVALUE() != null && option.getVALUE().equals(attribute.getAttributeValue())))
            return i;
        }
      ...
      else
      {
        if (NAME.equals(colSpec.property))
          ...
          return attribute.getAttributeValue() == null ? "" : attribute.getAttributeValue();
      }
    ...
    public void modify(Object element, String property, Object value)
    {
      ...
      if (widget instanceof DropdownT)
      {
        ...
        if (VALUE.equals(colSpec.property) && value instanceof Integer)
        {
          ...
          {
            // value was typed in (and dynamically added to colspec options)
  ...
  class AttributeContentProvider implements IStructuredContentProvider
  {
    ...
    {
      List<AttributeVO> variables = inputElement == null ? new ArrayList<AttributeVO>() : (List<AttributeVO>) inputElement;
