...
public class TimeInterval extends Composite {
    public enum Units {
        Seconds, Minutes, Hours, Days, Dynamic
    }
    ...
    public TimeInterval(Composite parent, int style, int value, Units units, int width,
            boolean expressionAllowed, Units[] acceptedUnits) {
        super(parent, style);
    ...
    private void createControls() {
        ...
        intervalField.setText(timerValue.getInterval().equals("0") ? ""
                : String.valueOf(timerValue.getInterval()));
