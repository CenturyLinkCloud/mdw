...
public class AssetDrivenActivityCustomSection extends DesignSection implements IFilter
{
  ...
  public void setSelection(WorkflowElement selection)
  {
    ...
    else
    {
      ...
      // setAttribute() must be called on property update (must not update activity directly)
  ...
  public boolean select(Object toTest)
  {
    ...
    if (activity.isManualTask())  // manual tasks have asset-driven widgets but no custom section
      return false;
