...
public class ProjectConnectionsSettings extends PropertySection implements IFilter, ElementChangeListener
{
  ...
  public void elementChanged(ElementChangeEvent ece)
  {
    if (ece.getChangeType().equals(ChangeType.SETTINGS_CHANGE))
    {
      if (ece.getNewValue() instanceof ServerSettings)
      {
        ...
        if (javaOptionsTextField != null && !javaOptionsTextField.getValue().equals(serverSettings.getJavaOptions()))
          javaOptionsTextField.setValue(serverSettings.getJavaOptions());
        if (debugModeCheckbox != null && !debugModeCheckbox.getValue().equals(String.valueOf(serverSettings.isDebug())))
          debugModeCheckbox.setValue(serverSettings.isDebug());
        if (debugPortTextField != null && !debugPortTextField.getValue().equals(String.valueOf(serverSettings.getDebugPort())))
          debugPortTextField.setValue(serverSettings.getDebugPort());
        if (debugSuspendCheckbox != null && !debugSuspendCheckbox.getValue().equals(String.valueOf(serverSettings.isSuspend())))
        ...
        if (!logWatchPortTextField.getValue().equals(String.valueOf(serverSettings.getLogWatcherPort())))
          logWatchPortTextField.setValue(serverSettings.getLogWatcherPort());
        if (!String.valueOf(serverSettings.getLogWatcherTimeout()).equals(logWatchTimeoutSpinner.getValue()))
        ...
        if (!stubServerPortTextField.getValue().equals(String.valueOf(serverSettings.getStubServerPort())))
          stubServerPortTextField.setValue(serverSettings.getStubServerPort());
        if (!String.valueOf(serverSettings.getStubServerTimeout()).equals(stubServerTimeoutSpinner.getValue()))
