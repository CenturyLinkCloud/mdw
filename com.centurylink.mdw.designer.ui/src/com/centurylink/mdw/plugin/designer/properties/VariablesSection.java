...
public class VariablesSection extends PropertySection implements IFilter
{
  ...
  private List<ColumnSpec> createColumnSpecs()
  {
    ...
    ColumnSpec sequenceColSpec = new ColumnSpec(PropertyEditor.TYPE_TEXT, "Seq.", "sequenceNumber");
  ...
  class VariableLabelProvider extends LabelProvider implements ITableLabelProvider
  {
    ...
    public String getColumnText(Object element, int columnIndex)
    {
      ...
      switch (columnIndex)
      {
        ...
        case 4:
          return variableVO.getDisplaySequence() == null ? null : variableVO.getDisplaySequence().toString();
        default:
          return null;
      }
    }
  ...
  class VariableCellModifier extends TableEditor.DefaultCellModifier
  {
    ...
    public Object getValue(Object element, String property)
    {
      ...
      switch (colIndex)
      {
        ...
        case 3:
          return variableVO.getVariableReferredAs() == null ? "" : variableVO.getVariableReferredAs();
        case 4:
          return variableVO.getDisplaySequence() == null ? "" : variableVO.getDisplaySequence().toString();
        default:
          return null;
      }
    }
  ...
  class VariableModelUpdater implements TableEditor.TableModelUpdater
  {
    public Object create()
    {
      ...
      variableVO.setVariableType(getVariableTypes().values().iterator().next().getVariableType());
