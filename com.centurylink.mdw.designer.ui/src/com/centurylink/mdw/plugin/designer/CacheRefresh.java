  ...
  public void doRefresh(boolean silent, final boolean includeDynamicJava)
  {
    try
    {
      ...
      else
      {
        ...
        {
          PluginMessages.uiError(workflowProject.getName() + " Refresh Caches and Properties failed.  Make sure baseline event handlers are registered.", "Refresh Caches", workflowProject);
        }
