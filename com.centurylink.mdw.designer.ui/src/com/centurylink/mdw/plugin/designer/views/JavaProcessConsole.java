 ...
 */
public class JavaProcessConsole extends ViewPart
  implements IAdaptable, IFindReplaceTarget, MouseListener, MouseTrackListener, MouseMoveListener, PaintListener
{
  private IJavaProject javaProject;
  public IJavaProject getJavaProject() { return javaProject; }
  public void setJavaProject(IJavaProject jp) { javaProject = jp;}

  private static String consoleId = null;
  public static String getConsoleId() { return consoleId; }
  public static void setConsoleId(String s) {consoleId = s; }
  ...
  public void setBufferSize(int i) { bufferSize = i; }
  ...
  public TextViewer getViewer() { return viewer; }
  ...
  /**
   * Gets a handle to a runtime instance of the console.  This method must
   * be run before show() or clear().
   *
   * @param id the console_id of the console to find
   * @return the console
   */
  ...
  protected static void show()
  {
    ...
    {
      // Eclipse Mars Bug: https://bugs.eclipse.org/bugs/show_bug.cgi?id=473541
   ...
   * @param lineType - style attributes
   */
  public void print(String text, int lineType)
  {
    ...
    {
      if ((LINE_TYPE_STATUS & lineType) == LINE_TYPE_STATUS || (LINE_TYPE_HIGHLIGHT & lineType) == LINE_TYPE_HIGHLIGHT)
        show();
...
//  }
      ...
      queueJob = new UIJob("JavaProcessConsole")
      {
        public IStatus runInUIThread(IProgressMonitor monitor)
        {
          ...
          synchronized(buffer)
          {
            ...
            // update the find replace action since the text has changed
  ...
  protected Cursor getHandCursor()
  {
    if (handCursor == null)
    {
      handCursor = new Cursor(org.eclipse.debug.internal.ui.DebugUIPlugin.getStandardDisplay(), SWT.CURSOR_HAND);
    }
    return handCursor;
  }
  ...
  protected Cursor getTextCursor()
  {
    if (textCursor == null)
    {
      textCursor = new Cursor(org.eclipse.debug.internal.ui.DebugUIPlugin.getStandardDisplay(), SWT.CURSOR_IBEAM);
    }
    return textCursor;
  }
