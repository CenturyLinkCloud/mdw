...
public class AutomatedTestActionGroup extends ActionGroup
{
  ...
  public IAction getFormatFunctionTestResultsAction() { return formatFunctionTestResultsAction; }
  ...
  public IAction getOpenTestCaseAction() { return openTestCase; }
  ...
  {
    return (selection instanceof AutomatedTestResults || selection instanceof LegacyExpectedResults);
  }
