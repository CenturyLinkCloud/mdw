...
/**
 * Interfaces for dynamically-configured lists (ala MDWTaskView.xml). Similar to
 * SortableList for webapps.
 *
 */
public class ListView extends ViewPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        // MdwPlugin.getPluginId() + ".task_list_help");
    }
    ...
    public void refreshTable() {
        BusyIndicator.showWhile(getSite().getShell().getDisplay(), new Runnable() {
            public void run() {
                ...
                int pageSize = 0; // TODO
                                  // contentProvider.getFilter().getPageSize().intValue();
