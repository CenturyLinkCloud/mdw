...
public class ProcessHierarchyContentProvider
    ...
    private void addTopLevelCallers(WorkflowProcess called)
            throws DataAccessException, RemoteException {
        List<WorkflowProcess> immediateCallers = called.getProject().getDesignerProxy()
                .findCallingProcesses(called);
    ...
    private void addCalledHierarchy(LinkedProcess caller)
        ...
        for (WorkflowProcess calledProcess : callerProcess.getProject().getDesignerProxy()
                .findCalledProcesses(callerProcess).toArray(new WorkflowProcess[0])) {
    ...
    public class LinkedProcess {
        ...
        public void setParent(LinkedProcess parent) {
            this.parent = parent;
        }
        ...
        public void setChildren(List<LinkedProcess> children) {
