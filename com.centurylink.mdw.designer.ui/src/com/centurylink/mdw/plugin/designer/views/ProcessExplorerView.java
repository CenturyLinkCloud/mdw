...
public class ProcessExplorerView extends ViewPart implements ITabbedPropertySheetPageContributor, IMenuListener
{
  ...
  public ProcessExplorerDropTarget getDropTarget() { return dropTarget; }
  ...
  public void createPartControl(Composite parent)
  {
      ...
      protected void handleTreeExpand(TreeEvent event)
      {
        if (event.item.getData() instanceof WorkflowProject)
        {
          ...
          else
          {
            ...
            { // has to be in a separate thread to take effect
    ...
    WorkflowProjectManager.getInstance().addElementChangeListener(contentProvider);  // for project adds/deletes
  ...
  public Object getAdapter(Class type)
  {
    ...
    if (type == IContextProvider.class)
      return org.eclipse.jdt.internal.ui.util.JavaUIHelp.getHelpContextProvider(this, MdwPlugin.getPluginId() + ".process_explorer_help");
