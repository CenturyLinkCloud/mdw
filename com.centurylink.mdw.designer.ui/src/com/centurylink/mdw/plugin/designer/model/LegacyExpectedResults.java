...
public class LegacyExpectedResults extends WorkflowElement implements Comparable<LegacyExpectedResults>
{
  ...
  {
    return getProject().getOldTestCasesFolder().getFolder(testCase.getName()).getFile(getExpectedResultFileName());
  }
