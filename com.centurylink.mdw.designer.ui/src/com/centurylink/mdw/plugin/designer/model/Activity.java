...
public class Activity extends WorkflowElement implements AttributeHolder {
    ...
    public void setInstances(List<ActivityInstanceVO> instances) {
    ...
    public List<TaskInstanceVO> getTaskInstances() {
        return taskInstances;
    }

    public void setTaskInstances(List<TaskInstanceVO> taskInstances) {
    ...
    public List<TaskInstanceVO> getSubTaskInstances() {
        return subTaskInstances;
    }

    public void setSubTaskInstances(List<TaskInstanceVO> subTaskInstances) {
        this.subTaskInstances = subTaskInstances;
    }

    public boolean hasSubTaskInstances() {
        return subTaskInstances != null && !subTaskInstances.isEmpty();
    }
    ...
    public boolean isProcessStart() {
        return node.getBaseClassName() != null && node.getBaseClassName().endsWith("StartActivity");
    }
    ...
    public boolean isHeterogeneousSubProcInvoke() {
        return isSubProcessInvoke()
                && getActivityImpl().getImplClassName().contains("Heterogeneous");
    }

    public boolean isManualTask() {
        return node.getBaseClassName() != null && node.getBaseClassName().endsWith("TaskActivity");
    }
    ...
    public boolean canWriteOutputDocs() {
        ...
        return implClass != null && !implClass.endsWith("ScriptEvaluator");
    }
