 ...
 */
public class WorkflowProcess extends WorkflowElement implements Versionable, AttributeHolder, IEditorInput, Comparable<WorkflowProcess>
{
  ...
  public void setProcessVO(ProcessVO processVO) { this.processVO = processVO; }

  private ProcessInstanceVO processInstanceInfo;
  public ProcessInstanceVO getProcessInstance() { return processInstanceInfo; }
  public void setProcessInstance(ProcessInstanceVO info) { this.processInstanceInfo = info; }
  public boolean hasInstanceInfo() { return processInstanceInfo != null; }

  private List<ProcessInstanceVO> embeddedSubProcessInstances;
  public List<ProcessInstanceVO> getEmbeddedSubProcessInstances() { return embeddedSubProcessInstances; }
  public void setEmbeddedSubProcessInstances(List<ProcessInstanceVO> embeddedInstances) { this.embeddedSubProcessInstances = embeddedInstances; }

  private Map<Long,List<TaskInstanceVO>> taskInstances;
  public Map<Long,List<TaskInstanceVO>> getTaskInstance() { return taskInstances; }
  public void setTaskInstances(Map<Long,List<TaskInstanceVO>> taskInstances) { this.taskInstances = taskInstances; }
  ...
  public List<WorkflowProcess> getDescendantProcessVersions() { return descendantProcessVersions; }
  public void setDescendantProcessVersions(List<WorkflowProcess> dpvs) { descendantProcessVersions = dpvs; }
  ...
  public WorkflowProcess getTopLevelVersion() { return topLevelVersion; }
  public void setTopLevelVersion(WorkflowProcess topLevelVersion) { this.topLevelVersion = topLevelVersion; }
  ...
  public List<String> getDocRefVariableNames()
  {
    ...
    for (VariableVO variableVO : variableVOs)
    {
      ...
      if ("com.qwest.mdw.model.FormDataDocument".equals(varType)  // TODO temp hack to work with MDW 4
  ...
  public List<VariableVO> getInputOutputVariables()
  {
    ...
    {
      int category = variableVO.getVariableCategory().intValue();
      if (category == VariableVO.CAT_INPUT || category == VariableVO.CAT_INOUT || category == VariableVO.CAT_OUTPUT || category == VariableVO.CAT_STATIC)
        inputVars.add(variableVO);
    }
    return inputVars;
  }
  ...
  public DesignerDataAccess getDesignerDataAccess() { return designerDataAccess; }
  public void setDesignerDataAccess(DesignerDataAccess dataAccess) { this.designerDataAccess = dataAccess; }

  /**
   * don't change the format of this output since it is use for drag-and-drop support
   */
  ...
  public void setAttributeOwnerDirty(String prefix, String ownerType, Long ownerId, boolean dirty)
  {
    if (prefix == null)
      return;
    if (dirty)
  ...
  public void fireElementChangeEvent(ChangeType changeType, Object newValue)
  {
    ...
    if (getProject().isFilePersist()) {
      if (changeType == ChangeType.ELEMENT_CREATE ||
