...
public class WorkflowAssetFactory
{
  public static WorkflowAsset createAsset(RuleSetVO ruleSetVO, WorkflowPackage workflowPackage)
  {
    ...
    else if (language.equals(RuleSetVO.DROOLS)
        || language.equals(RuleSetVO.GUIDED)
        || language.equals(RuleSetVO.EXCEL)
        || language.equals(RuleSetVO.EXCEL_2007))
    {
    ...
    else if (language.equals(RuleSetVO.FACELET)
        || language.equals(RuleSetVO.JSP)
        || language.equals(RuleSetVO.HTML)
        || language.equals(RuleSetVO.FORM)
        || language.equals(RuleSetVO.PAGELET))
    {
      return new Page(ruleSetVO, workflowPackage);
    }
    else if (language.equals(RuleSetVO.CSS)
        || language.equals(RuleSetVO.WEBSCRIPT)
        || language.equals(RuleSetVO.JAVASCRIPT)
        || language.equals(RuleSetVO.IMAGE_GIF)
        || language.equals(RuleSetVO.IMAGE_JPEG)
        || language.equals(RuleSetVO.IMAGE_PNG))
    {
