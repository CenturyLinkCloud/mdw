...
public class ExternalEvent extends WorkflowElement implements Comparable<ExternalEvent>
{
  ...
  public ExternalEventVO getExternalEventVO() { return externalEventVO; }
  ...
  public ExternalEvent() { } // don't use this constructor
  ...
  {
    return this.getExternalEventVO().getEventName().compareToIgnoreCase(other.getExternalEventVO().getEventName());
  }
