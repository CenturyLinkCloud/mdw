...
public class AutomatedTestSuite extends WorkflowElement
{
  ...
  public boolean isCreateReplaceResults() { return createReplaceResults; }
  public void setCreateReplaceResults(boolean createReplace) { this.createReplaceResults = createReplace; }

  private List<AutomatedTestCase> testCases;
  public List<AutomatedTestCase> getTestCases() { return testCases; }
  public void setTestCases(List<AutomatedTestCase> cases) { this.testCases = cases; }
  ...
  {
    return getProject().getTestResultsDir(isLoadTest() ? AutomatedTestCase.LOAD_TEST : AutomatedTestCase.FUNCTION_TEST);
  }
  ...
  public void writeTestCaseResults(AutomatedTestCase exeTestCase)
  {
    ...
    try
    {
      PluginUtil.writeFile(getProject().getFunctionTestResultsFile(), suiteBuf.toString().getBytes());
    }
      ...
      String finalStartTime, String finalEndTime,int totalProcessStarted,double speed,String resultDirectory)
  {
    ...
    suiteBuf.append(" <testsuite ");
    suiteBuf.append("name=\"").append(getProject().getLabel()).append("\" ");
    suiteBuf.append("tests=\"").append(getProject().getTestCases().size())
        .append("\" ");
    suiteBuf.append(">\n");
    ...
    try
    {
      PluginUtil.writeFile(getProject().getLoadTestResultsFile(), suiteBuf.toString().getBytes());
    }
    catch (IOException ex)
    {
      PluginMessages.log(ex);
