...
public class Transition extends WorkflowElement implements AttributeHolder
{
  ...
  public List<WorkTransitionInstanceVO> getInstances() { return instances; }
  public void setInstances(List<WorkTransitionInstanceVO> instances) { this.instances = instances; }
  ...
  {
    String retryCountAttr = link.conn.getAttribute(WorkTransitionAttributeConstant.TRANSITION_RETRY_COUNT);
  ...
  public void setRetryCount(int retryCount)
  {
    ...
    link.conn.setAttribute(WorkTransitionAttributeConstant.TRANSITION_RETRY_COUNT, retryCountAttr);
  }
