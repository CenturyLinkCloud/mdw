...
public class SearchResultsPage extends Page implements ISearchResultPage {
        ...
        for (int i = 0; i < table.getColumnCount(); i++) {
            ...
            SelectionListener listener = new SelectionAdapter() {
                public void widgetSelected(SelectionEvent e) {
                    ...
                    tableEditor.getTableViewer().setComparator(
                            getViewerComparator(tableEditor.getColumnSpecs().get(idx)));
                }
            };
    ...
    private TableEditor createTableEditor() {
        ...
        ColumnSpec projectColSpec = new ColumnSpec(PropertyEditor.TYPE_TEXT, "Project",
                "workflowProject");
        ...
        if (searchQuery != null && searchQuery.isInstanceQuery()) {
            ColumnSpec instanceColSpec = new ColumnSpec(PropertyEditor.TYPE_TEXT, "Instance ID",
                    "instanceId");
            ...
            ColumnSpec endDateColSpec = new ColumnSpec(PropertyEditor.TYPE_TEXT, "End",
                    "instanceEndDate");
        ...
        public String getColumnText(Object element, int columnIndex) {
            ...
            case 5:
                if ((workflowElement instanceof WorkflowProcess)
                        && workflowElement.hasInstanceInfo())
                    return ((WorkflowProcess) workflowElement).getProcessInstance().getId()
                            .toString();
            ...
            case 6:
                if ((workflowElement instanceof WorkflowProcess)
                        && workflowElement.hasInstanceInfo())
                    return WorkStatuses.getWorkStatuses().get(((WorkflowProcess) workflowElement)
                            .getProcessInstance().getStatusCode());
                else
                    return null;
            case 7:
                if ((workflowElement instanceof WorkflowProcess)
    ...
    public void setInput(ISearchResult result, Object uiState) {
        ...
        tableEditor.getTableViewer()
                .setComparator(getViewerComparator(tableEditor.getColumnSpecs().get(0)));
    }
