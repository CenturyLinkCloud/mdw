...
public abstract class SearchQuery implements ISearchQuery
{
  ...
  public SearchQuery(List<WorkflowProject> scopedProjects, SearchType searchType, String searchPattern, boolean caseSensitive, Shell shell)
  {
    this.scopedProjects = scopedProjects;
    this.searchType = searchType;
    this.pattern = caseSensitive ? searchPattern : searchPattern.toLowerCase();
    if (!pattern.equals("*"))
      pattern = pattern.replaceAll("\\*", "");  // ignore *s since we match pattern anywhere in name
