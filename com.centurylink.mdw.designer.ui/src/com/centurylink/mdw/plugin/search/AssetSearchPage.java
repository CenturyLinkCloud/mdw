...
public class AssetSearchPage extends SearchPage
{
  ...
  public String getEntityTitle() { return "Asset"; }
  ...
  {
    AssetSearchQuery query = new AssetSearchQuery(getScopedProjects(), getSearchType(), getSearchPattern(), isCaseSensitive(), getShell());
  ...
  protected void createSearchPatternControls(Composite parent)
  {
    ...
    resourceTypeCombo.setLayoutData(new GridData(GridData.FILL, GridData.FILL, true, false, 2, 1));
  ...
  protected Group createSearchTypeControls(Composite parent)
  {
    ...
    containedTextText.setLayoutData(new GridData(GridData.FILL, GridData.FILL, true, false, 2, 1));
