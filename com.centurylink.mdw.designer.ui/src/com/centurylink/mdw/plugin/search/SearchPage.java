...
public abstract class SearchPage extends DialogPage implements ISearchPage
{
  ...
  public ISearchPageContainer getContainer() { return searchPageContainer; }
  public void setContainer(ISearchPageContainer container) { searchPageContainer = container; }
  ...
  public SearchQuery.SearchType getSearchType() { return searchType; }
  public void setSearchType(SearchQuery.SearchType type) { this.searchType = type; }

  private List<WorkflowProject> scopedProjects;
  public List<WorkflowProject> getScopedProjects() { return scopedProjects; }
  public void setScopedProjects(List<WorkflowProject> projects) { this.scopedProjects = projects; }

  private WorkflowPackage selectedPackage;
  public WorkflowPackage getSelectedPackage() { return selectedPackage; }
  public void setSelectedPackage(WorkflowPackage selPkg) { this.selectedPackage = selPkg; }
