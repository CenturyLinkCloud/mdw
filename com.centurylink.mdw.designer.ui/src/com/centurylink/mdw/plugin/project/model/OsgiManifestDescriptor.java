...
public class OsgiManifestDescriptor
{
  ...
  public String getExportPackage() { return exportPackage; }
  public void setExportPackage(String s) { this.exportPackage = s; }

  private String privatePackage = "";
  public String getPrivatePackage() { return privatePackage; }
  public void setPrivatePackage(String s) { this.privatePackage = s; }

  private String importPackage = "";
  public String getImportPackage() { return importPackage; }
  public void setImportPackage(String s) { this.importPackage = s; }

  private String dynamicImportPackage = "";
  public String getDynamicImportPackage() { return dynamicImportPackage; }
  public void setDynamicImportPackage(String s) { this.dynamicImportPackage = s; }

  private String bundleActivator = "";
  public String getBundleActivator() { return bundleActivator; }
  public void setBundleActivator(String s) { this.bundleActivator = s; }

  private String bundleClasspath = "";
  public String getBundleClasspath() { return bundleClasspath; }
  public void setBundleClasspath(String s) { this.bundleClasspath = s; }

  private String webContextPath = "";
  public String getWebContextPath() { return webContextPath; }
  public void setWebContextPath(String s) { this.webContextPath = s; }

  private String symbolicName = "";
  public String getSymbolicName() { return symbolicName; }
  public void setSymbolicName(String s) { this.symbolicName = s; }
  ...
  public Manifest createManifest(String version, String mdwVersion) throws Exception
  {
    ...
    try
    {
      ...
      // (if META-INF/MANIFEST.MF already exists in outDir due to a Maven build,
      ...
      analyzer.setProperty("Import-Package", importPackage == null || importPackage.isEmpty() ? "*" : importPackage.replaceAll("\\s+", ""));
      ...
      if (dynamicImportPackage != null && !dynamicImportPackage.isEmpty())
        analyzer.setProperty("DynamicImport-Package", dynamicImportPackage.replaceAll("\\s+", ""));
      ...
      if (bundleClasspath != null && !bundleClasspath.isEmpty() && mdwVersion != null)
        analyzer.setProperty("Bundle-ClassPath", bundleClasspath.replaceAll("\\s+", "").replaceAll("\\$\\{mdw\\.version\\}", mdwVersion));
