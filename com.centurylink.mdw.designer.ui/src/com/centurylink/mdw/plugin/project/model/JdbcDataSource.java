...
public class JdbcDataSource {
     ...
     * TODO: mariadb
     */
    public static final String[] JDBC_DRIVERS = { "oracle.jdbc.OracleDriver",
            "oracle.jdbc.xa.client.OracleXADataSource", "com.mysql.jdbc.Driver",
    ...
    public boolean setJdbcUrlWithCredentialsOracle(String jdbcUrlWithCreds) {
        ...
        try {
            ...
            jdbcUrl = jdbcUrlWithCreds.substring(0, colonIdx + 1)
                    + jdbcUrlWithCreds.substring(atIdx);
    ...
    public String getJdbcUrlWithMaskedCredentialsOracle() {
        ...
        return jdbcUrl.substring(0, atIdx) + dbUser + "/" + maskedPassword
                + jdbcUrl.substring(atIdx);
    }
    ...
    public boolean equalsIgnoreMask(String jdbcUrl) {
        ...
        return getJdbcUrlWithMaskedCredentials().replaceAll("\\*", "")
                .equals(newDs.getJdbcUrlWithMaskedCredentials().replaceAll("\\*", ""));
    }
    ...
    public String getJdbcUrlWithEncryptedCredentialsOracle() {
        ...
        return jdbcUrl.substring(0, atIdx) + dbUser + "/" + encryptedPassword
                + jdbcUrl.substring(atIdx);
    }
    ...
    public void setSchemaOwner(String owner) {
        schemaOwner = owner;
    }
