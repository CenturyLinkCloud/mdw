...
public class ServerSettings implements PreferenceConstants {
    ...
    public enum ContainerType {
        JBoss, ServiceMix, Fuse, Tomcat, WebLogic
    }
    ...
    public void setJdkHome(String s) {
        jdkHome = s;
    }
    ...
    public void setServerLoc(String s) {
        serverLoc = s;
    }
    ...
    public String getJavaOptions() {
        // TODO: currently these are manually kept in sync with the constants in
        // ServiceMixServerBehavior & FuseServerBehavior - should refactor
    ...
    public void setJavaOptions(String opts) {
        this.javaOptions = opts;
    }
    ...
    public String getLogWatcherHost() {
        return logWatcherHost;
    }

    public void setLogWatcherHost(String host) {
        this.logWatcherHost = host;
    }

    private int logWatcherPort;

    public int getLogWatcherPort() {
        return logWatcherPort;
    }

    public void setLogWatcherPort(int port) {
        this.logWatcherPort = port;
    }

    private int logWatcherTimeout;

    public int getLogWatcherTimeout() {
        return logWatcherTimeout;
    }

    public void setLogWatcherTimeout(int timeout) {
        this.logWatcherTimeout = timeout;
    }

    private String stubServerHost;

    public String getStubServerHost() {
        return stubServerHost;
    }

    public void setStubServerHost(String host) {
        this.stubServerHost = host;
    }
    ...
    public void setStubServerPort(int port) {
        this.stubServerPort = port;
    }

    private int stubServerTimeout;

    public int getStubServerTimeout() {
        return stubServerTimeout;
    }

    public void setStubServerTimeout(int timeout) {
        this.stubServerTimeout = timeout;
    }
    ...
    public String getServerProcessId() throws IOException, InterruptedException {
        ...
        Process p = Runtime.getRuntime()
                .exec(new String[] { PluginUtil.getJdkBin() + File.separator + "jps", "-l" });
    ...
    public boolean equals(Object o) {
        ...
        return isEqual(home, other.home) && isEqual(host, other.host) && port == other.port
                && isEqual(containerType, other.containerType)
                && isEqual(containerVersion, other.containerVersion)
                && isEqual(jdkHome, other.jdkHome) && isEqual(serverLoc, other.serverLoc)
                && isEqual(user, other.user) && isEqual(password, other.password)
                && isEqual(serverName, other.serverName) && isEqual(domainName, other.domainName)
                && isEqual(debug, other.debug) && debugPort == other.debugPort
                && suspend == other.suspend && isEqual(logWatcherHost, other.logWatcherHost)
