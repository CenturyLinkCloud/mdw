...
public class VcsRepository {
    ...
    public List<String> getPkgPrefixes() {
        return pkgPrefixes;
    }

    public void setPkgPrefixes(List<String> prefixes) {
        this.pkgPrefixes = prefixes;
    }
    ...
    public String getRepositoryUrlWithCredentials() {
        ...
        return repositoryUrl.substring(0, slashSlash + 2) + user + ":" + password + "@"
    ...
    public boolean setRepositoryUrlWithCredentials(String repoUrlWithCreds) {
        ...
        if (at == -1) {
            ...
            try {
                ...
                repositoryUrl = repoUrlWithCreds.substring(0, slashSlash + 2)
                        + repoUrlWithCreds.substring(at + 1);
    ...
    public String getRepositoryUrlWithMaskedCredentials() {
        ...
        int slashSlash = repositoryUrl.indexOf("//");
        return repositoryUrl.substring(0, slashSlash + 2) + user + ":" + maskedPassword + "@"
                + repositoryUrl.substring(slashSlash + 2);
    }
    ...
    public boolean equalsIgnoreMask(String repoUrl) {
        ...
        return getRepositoryUrlWithMaskedCredentials().replaceAll("\\*", "")
                .equals(newRepo.getRepositoryUrlWithMaskedCredentials().replaceAll("\\*", ""));
    }
    ...
    public String getRepositoryUrlWithEncryptedCredentials() {
        ...
        int slashSlash = repositoryUrl.indexOf("//");
        return repositoryUrl.substring(0, slashSlash + 2) + user + ":" + encryptedPassword + "@"
                + repositoryUrl.substring(slashSlash + 2);
    }
    ...
    public boolean isSyncAssetArchive() {
        return syncAssetArchive;
    }

    public void setSyncAssetArchive(boolean sync) {
        this.syncAssetArchive = sync;
    }
