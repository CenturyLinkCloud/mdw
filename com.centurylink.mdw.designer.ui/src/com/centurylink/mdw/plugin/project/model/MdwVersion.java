...
public class MdwVersion
{
  ...
  public boolean checkRequiredVersion(String requiredVersion) throws NumberFormatException
  {
    ...
    if (parts.length == 1)
      ...
      return checkRequiredVersion(Integer.parseInt(parts[0]), Integer.parseInt(parts[1]), Integer.parseInt(parts[2]));
    else
      return false;
  }
  ...
  public int getMinorVersion()
  {
    ...
    return idxSecondDot == -1 ? Integer.parseInt(version.substring(idxFirstDot + 1)) : Integer.parseInt(version.substring(idxFirstDot + 1, idxSecondDot));
  }
