...
public class WebLogicSettingsPage extends ServerSettingsPage {
    ...
    public boolean checkForAppropriateRuntime(IRuntime runtime) {
        if (runtime.getRuntimeType() != null) {
            ...
            return ("BEA Systems, Inc.".equals(vendor) || "Oracle".equals(vendor))
                    && (version != null && version.startsWith("10"));
        }
        return false;
    }
    ...
    protected String serverHomeSpecializedCheck(String serverHome) {
        if (serverHome != null && serverHome.length() != 0
                && !checkFile(serverHome + "/server/lib/weblogic.jar"))
    ...
    public boolean isPageComplete() {
        ...
        return super.isPageComplete() && checkStringNoWhitespace(wlSettings.getUser())
