...
public class ExtensionModulesUpdater
{
  ...
  public List<ExtensionModule> getAdds() { return adds; }
  public void setAdds(List<ExtensionModule> adds) { this.adds = adds; }
  public boolean hasAdds() { return adds != null && adds.size() > 0; }

  private List<ExtensionModule> removes;
  public List<ExtensionModule> getRemoves() { return removes; }
  public void setRemoves(List<ExtensionModule> removes) { this.removes = removes; }
  public boolean hasRemoves() { return removes != null && removes.size() > 0; }
  ...
  public void doChanges(Shell shell)
  {
    ...
    if (hasRemoves())
    {
      ...
      if (PluginMessages.uiList(shell, confirm, "Remove Extension Modules", removes) == Dialog.OK)
      {
