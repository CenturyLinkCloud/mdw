...
public abstract class ExtensionModule implements IFilter, Comparable<ExtensionModule>
{
   ...
   */
  public String getRequiredMdwVersion() { return requiredMdwVersion; }
  public void setRequiredMdwVersion(String v) { this.requiredMdwVersion = v; }
  ...
  /**
   * Callback for adding this extension to the designated workflow project. Allocated 100 monitor ticks.
   * @return true if add was successful and should continue (workflow project references should be added)
   */
  public abstract boolean addTo(WorkflowProject project, IProgressMonitor monitor) throws ExtensionModuleException, InterruptedException;

  /**
   * Callback for interacting with the UI as necessary for adding this extension to the designated project.
   * @return true if add was successful and should continue (workflow project references should be added)
   */
  ...
  /**
   * Callback for removing this extension from the designated workflow project. Allocated 100 monitor ticks.
   * @return true if removal was successful and should continue (workflow project references should be removed)
   */
  public abstract boolean removeFrom(WorkflowProject project, IProgressMonitor monitor) throws ExtensionModuleException, InterruptedException;

  /**
   * Callback for interacting with the UI as necessary for removing this extension to the designated project.
   * @return true if removal was successful and should continue (workflow project references should be removed)
   */
  ...
  /**
   * Callback for updating this extension for the designated workflow project. Allocated 100 monitor ticks.
   * @return true if update was successful
   */
  public abstract boolean update(WorkflowProject project, IProgressMonitor monitor) throws ExtensionModuleException, InterruptedException;
  ...
  /**
   * Object is an instance of WorkflowProject.  Return false to suppress extension.
   * Default implementation checks for required MDW version (5.1 if not specified).
   */
