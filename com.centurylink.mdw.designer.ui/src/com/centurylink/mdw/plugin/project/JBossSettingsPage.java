...
public class JBossSettingsPage extends ServerSettingsPage
{
  ...
  public String getServerName() { return "JBoss"; }
  ...
  public boolean checkForAppropriateRuntime(IRuntime runtime)
  {
    ...
    return (vendor.equals("JBoss Community") || vendor.equals("JBoss") || vendor.equals("JBoss Enterprise Middleware")) && version.startsWith("5");    
  }
  
  protected String serverHomeSpecializedCheck(String serverHome)
  {
    if (serverHome != null && serverHome.length() != 0 && !checkFile(serverHome + "/lib/jboss-j2se.jar"))
