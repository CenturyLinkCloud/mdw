...
public class RemoteWorkflowProjectWizard extends Wizard implements INewWizard {
    ...
    public RemoteHostInfoPage getRemoteHostInfoPage() {
        return remoteHostInfoPage;
    }
                ...
                public void run(IProgressMonitor monitor)
                    ...
                    if (workflowProject.isFilePersist()) {
                        try {
                            ...
                            projectDir.mkdir();
                            String repositoryUrl = workflowProject.getMdwVcsRepository()
                                    .getRepositoryUrl();
                            if (repositoryUrl != null && repositoryUrl.length() > 0) {
                                ...
                                vcsGit.connect(gitRepo.getRepositoryUrl(), gitRepo.getUser(),
                                        gitRepo.getPassword(), projectDir);
                                vcsGit.cloneRepo();
                            }
                            else {
                    ...
                    monitor.worked(50);
                    ProjectInflator projectInflator = new ProjectInflator(workflowProject,
