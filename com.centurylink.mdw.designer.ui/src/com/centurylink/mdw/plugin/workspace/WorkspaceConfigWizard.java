...
public class WorkspaceConfigWizard extends Wizard
{
  ...
  public WorkspaceConfig getWorkspaceConfig() { return workspaceConfig; }
  ...
  {
    WorkspaceConfigurator configurator = new WorkspaceConfigurator(getWorkspaceConfig(), getShell());
    try
    {
      getContainer().run(false, true, new org.eclipse.jdt.internal.ui.actions.WorkbenchRunnableAdapter(configurator));
