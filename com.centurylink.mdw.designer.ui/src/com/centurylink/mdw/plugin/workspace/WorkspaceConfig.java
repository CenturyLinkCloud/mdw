...
{
  public static final String[] CODE_FORMATTERS = { "CenturyLink IT Code Formatter", "MDW Code Formatter" };
  public static final String[] CODE_TEMPLATES = { "CenturyLink IT Code Templates", "MDW Code Templates" };
  ...
  public String getCodeFormatter() { return codeFormatter; }
  public void setCodeFormatter(String formatter) { this.codeFormatter = formatter; }
  
  private String codeTemplates = CODE_TEMPLATES[0];
  public String getCodeTemplates() { return codeTemplates; }
  public void setCodeTemplates(String templates) { this.codeTemplates = templates; }

  private boolean eclipseAutobuild;
  public boolean isEclipseAutobuild() { return eclipseAutobuild; }
  public void setEclipseAutobuild(boolean b) { eclipseAutobuild = b; }
  ...
  public String toString()
  {
    return "codeFormatter: " + getCodeFormatter() + "\n"
      + "codeTemplates: " + getCodeTemplates() + "\n"
