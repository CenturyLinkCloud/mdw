...
public class ExternalEventLaunchShortcut implements ILaunchShortcut
{
  ...
  private void performLaunch(ExternalEvent externalEvent, String mode) throws InterruptedException, CoreException
  {
  ...
  protected ILaunchConfigurationWorkingCopy createLaunchConfiguration(ExternalEvent externalEvent) throws CoreException
  {
    ...
    wc.setAttribute(ExternalEventLaunchConfiguration.MESSAGE_PATTERN, externalEvent.getMessagePattern());
    return wc;
  }
  ...
  private ILaunchConfiguration findExistingLaunchConfiguration(ILaunchConfigurationWorkingCopy workingCopy) throws CoreException
  {
    ...
    String wcMessagePattern = workingCopy.getAttribute(ExternalEventLaunchConfiguration.MESSAGE_PATTERN, "");
    ...
    for (ILaunchConfiguration launchConfig : configs)
    {
      ...
      if (!wcWorkflowProject.equals(workflowProject))
        continue;
      String messagePattern = launchConfig.getAttribute(ExternalEventLaunchConfiguration.MESSAGE_PATTERN, "");
