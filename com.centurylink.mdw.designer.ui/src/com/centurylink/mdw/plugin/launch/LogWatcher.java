...
public class LogWatcher implements ConsoleRunnableEntity
{
  ...
  protected WorkflowProject getProject() { return process.getProject(); }
  ...
  private void processQueue()
  {
    while (isRunning())
    {
      ...
      synchronized(this)
      {
        ...
        //isEmbedded = pid == null ? false : isEmbeddedProcess(processInstanceInfos.get(pid.getProcessInstanceId()));
  ...
  private boolean isEmbeddedProcess(ProcessInstanceVO processInstance)
  {
    ...
    if (parentInstance == null)
      return false; // possible when the instance is a subprocess of an embedded
