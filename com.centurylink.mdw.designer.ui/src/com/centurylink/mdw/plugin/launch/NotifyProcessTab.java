...
public class NotifyProcessTab extends AbstractLaunchConfigurationTab {
    ...
    public void initializeFrom(ILaunchConfiguration launchConfig) {
        try {
            ...
            boolean notifyProcess = launchConfig
                    .getAttribute(ProcessLaunchConfiguration.NOTIFY_PROCESS, false);
            ...
            String eventName = launchConfig
                    .getAttribute(WorkflowLaunchConfiguration.NOTIFY_PROCESS_EVENT, "");
            eventNameText.setText(eventName);
            String request = launchConfig
                    .getAttribute(WorkflowLaunchConfiguration.NOTIFY_PROCESS_REQUEST, "");
