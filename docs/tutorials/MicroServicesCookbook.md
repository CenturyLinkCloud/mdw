...
This document contains information about exposing and consuming through a RESTFul Web Service. For a SOAP document-style Web Service, please refer to [TomcatCookbook](TomcatCookbook).
...
- For detailed documentation covering the designer, refer to the [MDW Designer User Guide:](DesignerUserGuide)
