...
This project is available from our GitHub instance in the CenturyLink Labs cloud.  You can clone this easily using   
   Eclipse as described below.  If you prefer to use command line Git, clone the repository from
...
##### Getting a Cloud Foundry Space:
-	TODO: Describe the steps for getting set up with a Cloud Foundry space in the CenturyLink IT PCF dev environment.
    ...
