...
- Install the latest version of the MDW Plugin via Eclipse Software Updates (Help > Install New Software > Add > http://centurylinkcloud.github.io/MDW/docs/designer > Install).
