...
### Steps in this Guide
  ...
  1. [Setup](#1-setup) 
  2. [Create a service process](#2-create-a-service-process)
  3. [Run the process and view its instances](#3-run-the-process-and-view-its-instances)
  4. [Expose the process as a REST service](#4-expose-the-process-as-a-rest-service)
  5. [Document the service API using Swagger](#5-document-the-service-api-using-swagger)
  6. [Auto-validate requests against the API](#6-auto-validate-requests-against-the-api)
...
### 3. Run the process and view its instances
...
### 4. Expose the process as a REST service
...
### 5. Document the Service API using Swagger
...
### 6. Auto-validate requests against the API
...
#### Add API model annotations
  - Grab the completed version of mdw-demo's Bug.java asset, and let's take a look at how to incorporate API model annotations.  Here's where it lives
    on GitHub: <https://raw.githubusercontent.com/CenturyLinkCloud/mdw-demo/master/assets/com/centurylink/mdw/demo/bugs/Bug.java>.  Overwrite your
