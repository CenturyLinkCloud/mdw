...
- When you have your eclipse workspace setup and deployed the mdw-demo project on the Tomcat server, move on to step `1. Create a  Workflow Process` bellow to continue with this tutorial.
