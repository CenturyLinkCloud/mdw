...
public class TestCase {
    ...
    public Status getCaseStatus() {
        ...
        switch (status)
        {
          case TestCase.STATUS_RUNNING:
              return Status.InProgress;
          case TestCase.STATUS_PASS:
              return Status.Passed;
          case TestCase.STATUS_FAIL:
              return Status.Failed;
          case TestCase.STATUS_ERROR:
              return Status.Errored;
          case TestCase.STATUS_STOP:
              return Status.Stopped;
          case TestCase.STATUS_WAITING:
    ...
    public void setStatus(Status caseStatus) {
        if (caseStatus == null) {
            status = TestCase.STATUS_NOT_RUN;
        }
        else {
            switch (caseStatus)
            {
              case InProgress:
                  status = TestCase.STATUS_RUNNING;
                  break;
              case Passed:
              ...
              case Errored:
                  ...
                  break;
              case Stopped:
                  status = TestCase.STATUS_STOP;
                  break;
              case Waiting:
                  status = TestCase.STATUS_WAITING;
                  break;
            }
        }
