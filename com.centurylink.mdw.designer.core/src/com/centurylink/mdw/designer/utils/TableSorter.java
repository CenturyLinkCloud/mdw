 ...
 * <p/>
 *
 * Modifications by Jiyang:
 *  1) adapted to java 1.5 syntax
 *  2) add paginator option
 */
...
public class TableSorter extends AbstractTableModel {
    ...
    public static final String ACTION_TABLE_SORTING = "TABLE_SORTING";
    ...
    private ActionListener paginator_listener;

    public TableSorter() {
        this.mouseListener = new MouseHandler();
        this.tableModelListener = new TableModelHandler();
        paginator_listener = null;
    }
    ...
    public void setPaginator(ActionListener listener) {
    	this.paginator_listener = listener;
    }
    ...
    public void setTableHeaderX(JTableHeader tableHeader) {
    ...
    public Row[] getViewToModel() {
        if (viewToModel == null) {
            ...
            if (isSorting() && paginator_listener==null) {
    ...
    private class MouseHandler extends MouseAdapter {
        public void mouseClicked(MouseEvent e) {
            ...
            if (column != -1) {
                ...
                if (paginator_listener!=null) {
                	if (status!=0) {
                		ActionEvent event = new ActionEvent(h, status*(column+1), ACTION_TABLE_SORTING);
                		paginator_listener.actionPerformed(event);
                		if (event.getSource()==null) {	// not sortable
                			status = 0;
                		}
                	}
                }
