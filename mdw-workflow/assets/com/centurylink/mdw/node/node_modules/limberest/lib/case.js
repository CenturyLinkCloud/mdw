...
NoExpectedResult.prototype = new Error();
...
var Case = exports.Case = function(name, options) {
  ...
  if (this.options.overwrite) {
    this.expecteResultStorage.remove();
  }
  ...
  this.logger.info(logger.storage);
};
...
Case.prototype.verify = function(values) {
  if (!this.expectedResultStorage.exists())
    throw new NoExpectedResult('Expected result not found: ' + this.expectedResultStorage);
