...
public class MicroserviceRestAdapter extends RestServiceAdapter {
    ...
    protected Long logResponse(Response response) {
        ...
        outDocs[0] = ServiceSummaryConstants.SERVICE_SUMMARY;
    ...
    public void updateServiceSummary(Status status, Long responseId)
        ...
        if (serviceSummary != null) {
            ...
            setVariableValue(ServiceSummaryConstants.SERVICE_SUMMARY, serviceSummary);
    ...
    public ServiceSummary getServiceSummary() throws ActivityException {
        ServiceSummary serviceSummary = (ServiceSummary) getVariableValue(
                ServiceSummaryConstants.SERVICE_SUMMARY);
        if (serviceSummary == null) {
            logger.severe(ServiceSummaryConstants.SERVICE_SUMMARY + " not found");
            return null;
        }
        else {
    ...
    public Long getRequestId() throws ActivityException {
        ...
        String requestIdVarName = getAttributeValue(ServiceSummaryConstants.REQUEST_ID_VAR);
        if (requestIdVarName == null)
            requestIdVarName = ServiceSummaryConstants.DEFAULT_REQUEST_ID_VAR;
