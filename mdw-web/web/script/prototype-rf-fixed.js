...
// MDW NOTE: patched prototype.js inside richfaces-impl-jsf2-3.3.3.jar
...
(function() {
  ...
  function getOffsetParent(element) {
    ...
    while ((element = element.parentNode) && element !== document.body && Object.isElement(element) /* RichFaces */) {
  ...
  function viewportOffset(forElement) {
    ...
    } while ((element = element.offsetParent) && element.tagName);  // RichFaces
...
(function(GLOBAL) {
  ...
  if (window.attachEvent) {
    ...
    Event.extend = function(event, element) {
      ...
      // event._stopPropagation = event.stopPropagation; // RichFaces Not Needed
      // event._preventDefault = event.preventDefault; // RichFaces Not Needed
  ...
  function observeStandardEvent(element, eventName, responder) {
    ...
    if (element.addEventListener && !Prototype.Browser.IE_9) {
...
(function(GLOBAL) {
  ...
  if (document.readyState === 'complete') {
    // RichFaces (not really -- https://github.com/sstephenson/prototype/commit/addd725de13bcef84e31ae791cd81e98a1844a06)
    // We must have been loaded asynchronously, because the DOMContentLoaded
    // event has already fired. We can just fire `dom:loaded` and be done with it.
    fireContentLoadedEvent();
    return;
  }  
...
// RichFaces memory-leaks sanitizing code
if (!window.RichFaces) {
  window.RichFaces = {};
}
