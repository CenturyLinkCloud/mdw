...
{
  public static final String RENDERER_TYPE = "com.centurylink.mdw.web.jsf.renderers.NavigationMenuRenderer";
  ...
  protected void renderToggleJavaScript(FacesContext facesContext, NavigationMenu navMenu, boolean active, List<NavigationMenu> sibMenus) throws IOException
  {
    ...
    if (!active)
    {
      ...
      script.append("  var meExp = ('true' == me.getAttribute('" + EXPANDED_ATTR + "') || '" + EXPANDED_ATTR + "' == me.getAttribute('" + EXPANDED_ATTR + "'));\n");
