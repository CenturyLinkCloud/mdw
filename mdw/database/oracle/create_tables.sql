...
(
  ...
  VARIABLE_TYPE     VARCHAR2(256 BYTE)
);
...
(
  ...
  ATTACHMENT_LOCATION      VARCHAR2(1000 BYTE)  NOT NULL,
  CREATE_DT                DATE                 DEFAULT SYSDATE               NOT NULL,
  CREATE_USR               VARCHAR2(100 BYTE)   DEFAULT USER                  NOT NULL,
  MOD_DT                   DATE,
  MOD_USR                  VARCHAR2(100 BYTE),
  ATTACHMENT_CONTENT_TYPE  VARCHAR2(1000 BYTE)
);
...
(
  ...
  STATUS_CD             NUMBER(2)              NOT NULL,
  START_DT              TIMESTAMP              DEFAULT SYSTIMESTAMP          NOT NULL,
  END_DT                TIMESTAMP,
  CREATE_DT             TIMESTAMP              DEFAULT SYSTIMESTAMP          NOT NULL,
  CREATE_USR            VARCHAR2(30 BYTE)      DEFAULT USER                  NOT NULL,
  MOD_DT                TIMESTAMP,
