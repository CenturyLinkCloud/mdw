...
2 - Run the updateMdwVerInFiles Gradle task to update these files: 
...
5 - Verify release artifact are published to Maven Central (https://oss.sonatype.org/#stagingRepositories)
...
11 - Run task 1,2 & 5 and commit the files to start work on post release SNAPSHOT builds
