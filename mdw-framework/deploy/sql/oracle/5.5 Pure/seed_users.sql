...
values (MDW_COMMON_ID_SEQ.nextVal, 'dxoakes', 'BASELINE5.5', 'Donald Oakes'); 

insert into user_info 
(user_info_id, cuid, create_usr, name)
values (MDW_COMMON_ID_SEQ.nextVal, 'aa56486', 'BASELINE5.5', 'Manoj Agrawal'); 

insert into user_info 
(user_info_id, cuid, create_usr, name)
values (MDW_COMMON_ID_SEQ.nextVal, 'jbrojde', 'BASELINE5.5', 'Jack Brojde'); 
