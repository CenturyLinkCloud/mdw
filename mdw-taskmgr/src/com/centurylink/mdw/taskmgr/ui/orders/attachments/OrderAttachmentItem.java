...
public class OrderAttachmentItem extends AttachmentItem {

	private static StandardLogger logger = LoggerUtil.getStandardLogger();

	public OrderAttachmentItem() {

	}

	public OrderAttachmentItem(Attachment orderAttachment) {
	 ...
	 try
	    {
	      ...
	      taskMgr.addAttachment(getName(), getLocation(), getContentType(), user.getCuid(),
	    		  getOwner(),getOwnerId());
	    }
	    catch (Exception ex)
	    {
	...
	public void delete() {
		try
	    {
	      ...
	      if (getLocation().startsWith(MiscConstants.ATTACHMENT_LOCATION_PREFIX)) {
