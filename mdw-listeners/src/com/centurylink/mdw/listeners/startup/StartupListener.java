...
public class StartupListener implements ServletContextListener
{
    ...
    public void onStartup(ServletContext servletContext) {
        ...
        try {
            ...
            // none of the following are needed for mdwadmin
            if (servletContext.getContextPath().equals("/" + ApplicationContext.getTaskManagerContextRoot())
                    && !servletContext.getContextPath().equals("/" + ApplicationContext.getMdwHubContextRoot()))
                return;
            ...
            //
            if (!(ApplicationContext.isCloud() && SpringAppContext.getInstance().isBeanDefined(SpringConstants.MDW_SPRING_INTERNAL_EVENT_LISTENER) )) {
